...
public class TelaInicial {
	...
	private void initialize() {
		...
		frmMenuInicial.setBounds(100, 100, 1100, 775);
		...
		frmMenuInicial.getContentPane().add(lblMatricula, "22, 14, 5, 1");
		
		textField = new JTextField();
		textField.setFont(new Font("Tahoma", Font.PLAIN, 18));
		textField.setToolTipText("Insira sua matrícula");
		frmMenuInicial.getContentPane().add(textField, "22, 16, 5, 1, fill, default");
		textField.setColumns(10);
		
		lblSenha = new JLabel("Senha");
		lblSenha.setFont(new Font("Tahoma", Font.PLAIN, 18));
		frmMenuInicial.getContentPane().add(lblSenha, "22, 18, 5, 1");
		
		pswSenha = new JPasswordField();
		pswSenha.setFont(new Font("Tahoma", Font.PLAIN, 18));
		pswSenha.setToolTipText("Insira sua senha");
		frmMenuInicial.getContentPane().add(pswSenha, "22, 20, 5, 1, fill, default");
		
		btnEntrar = new JButton("ENTRAR");
		btnEntrar.setFont(new Font("Tahoma", Font.PLAIN, 18));
		frmMenuInicial.getContentPane().add(btnEntrar, "24, 50");
	}
